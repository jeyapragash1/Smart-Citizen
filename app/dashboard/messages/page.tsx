    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 text-sm mt-1">Send messages to GS officers, DS officers, and Admins</p>
        </div>
        <button
                ...
                filteredConversations.map(conv => (
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 border-b border-gray-100 hover:bg-gray-50 transition-colors ${
                      selectedChat?.partner_nic === conv.partner_nic ? 'bg-blue-50 border-l-4 border-l-blue-600' : ''
                    }`}
                  >
                  ...
                  messages.map(msg => (
                    ...
                    >
                      ...
                      >
                        ...
                        <p className={`text-xs mt-1 ${msg.is_own ? 'text-blue-100' : 'text-gray-500'}`}>
