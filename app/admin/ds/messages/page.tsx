    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 text-sm mt-1">Communicate with Citizens, GS officers, and Admins</p>
        </div>
        <button
          onClick={handleStartNewConversation}
          className="bg-purple-600 text-white px-5 py-2.5 rounded-lg flex items-center gap-2 hover:bg-purple-700 font-medium transition-colors shadow-md"
        >
                ...
                filteredConversations.map(conv => (
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 border-b border-gray-100 hover:bg-gray-50 transition-colors ${
                      selectedChat?.partner_nic === conv.partner_nic ? 'bg-purple-50 border-l-4 border-l-purple-600' : ''
                    }`}
                  >
                  ...
                  messages.map(msg => (
                    ...
                    >
                      ...
                      >
                        ...
                        <p className={`text-xs mt-1 ${msg.is_own ? 'text-purple-100' : 'text-gray-500'}`}>
              ...
              <div className="p-4 border-t border-gray-200 bg-white">
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="bg-purple-600 text-white px-6 py-2 rounded-lg hover:bg-purple-700 disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center gap-2 transition-colors"
                  >
